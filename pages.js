  ...
  home: {
    ru: {
      ...
      content: `
        ...
        <div class="rule-box">
          <strong>🌍 Защита</strong> — гриферство запрещено, кроме как во время специальных ивентов.
        </div>
        
        <h3>Присоединяйся!</h3>
        <p>Версия сервера: <strong>1.21.1</strong></p>
        <p>IP сервера: <strong><span onclick="copyToClipboard('noctrl.nolags.fun')" style="cursor: pointer; color: #ffd700;" title="Нажмите для копирования">noctrl.nolags.fun</span> Порт(не обязательно) <span onclick="copyToClipboard('20036')" style="cursor: pointer; color: #ffd700;" title="Нажмите для копирования">20036</span></strong></p>
    ...
    en: {
      ...
      content: `
        ...
        <div class="rule-box">
          <strong>🌍 Moderation</strong> — griefing is forbidden, except during special events.
        </div>
        
        <h3>Join Us!</h3>
        <p>Server Version: <strong>1.21.1</strong></p>
        <p>Server IP: <strong><span onclick="copyToClipboard('noctrl.nolags.fun')" style="cursor: pointer; color: #ffd700;" title="Click to copy">noctrl.nolags.fun</span> Port(optional) <span onclick="copyToClipboard('20036')" style="cursor: pointer; color: #ffd700;" title="Click to copy">20036</span></strong></p>
      ...
      content: `
        ...
        <div class="faq-item">
          ...
          <div class="faq-answer">
            ...
            <ul>
              <li><a href="https://discord.com/channels/1450558110854021233/1450584397874073692" target="_blank" style="color: #ffd700; text-decoration: underline;">Support</a> — общие вопросы</li>
              <li><a href="https://discord.com/channels/1450558110854021233/1450565031413682296" target="_blank" style="color: #ffd700; text-decoration: underline;">Tech Support</a> — технические проблемы</li>
              <li><a href="https://discord.com/channels/1450558110854021233/1450565050950750218" target="_blank" style="color: #ffd700; text-decoration: underline;">Report Player</a> — репорты о игроках</li>
            </ul>
          </div>
        </div>
      `
      ...
      content: `
        ...
        <div class="faq-item">
          ...
          <div class="faq-answer">
            ...
            <ul>
              <li><a href="https://discord.com/channels/1450558110854021233/1450584397874073692" target="_blank" style="color: #ffd700; text-decoration: underline;">Support</a> — general questions</li>
              <li><a href="https://discord.com/channels/1450558110854021233/1450565031413682296" target="_blank" style="color: #ffd700; text-decoration: underline;">Tech Support</a> — technical issues</li>
              <li><a href="https://discord.com/channels/1450558110854021233/1450565050950750218" target="_blank" style="color: #ffd700; text-decoration: underline;">Report Player</a> — report players</li>
            </ul>
          </div>
        </div>
      `
  ...
  map: {
    ru: {
      ...
      content: `
        ...
        <div style="position: relative; display: inline-block; width: 100%; max-width: 100%;">
          <iframe id="mapIframe" src="http://noctrl.nolags.fun:20903/" loading="lazy" style="width: 100%; height: 600px; border: 2px solid #ffd700; border-radius: 8px; display: block;"></iframe>
          <button onclick="openMapFullscreen()" style="position: absolute; bottom: 10px; right: 10px; background: #ff9800; color: white; border: none; padding: 10px 15px; border-radius: 6px; cursor: pointer; font-size: 14px; font-weight: bold; z-index: 10; box-shadow: 0 4px 8px rgba(0,0,0,0.3); transition: all 0.3s ease;" onmouseover="this.style.background='#ffb74d'; this.style.transform='scale(1.05)'" onmouseout="this.style.background='#ff9800'; this.style.transform='scale(1)'">🔍 Полный экран</button>
        </div>
        
        <p><strong>Если карта не загружается:</strong></p>
        <p>Откройте карту в отдельном окне: <strong><a href="http://noctrl.nolags.fun:20903/" target="_blank" style="color: #ffd700; text-decoration: underline;">http://noctrl.nolags.fun:20903/</a></strong></p>
    ...
    en: {
      ...
      content: `
        ...
        <div style="position: relative; display: inline-block; width: 100%; max-width: 100%;">
          <iframe id="mapIframe" src="http://noctrl.nolags.fun:20903/" loading="lazy" style="width: 100%; height: 600px; border: 2px solid #ffd700; border-radius: 8px; display: block;"></iframe>
          <button onclick="openMapFullscreen()" style="position: absolute; bottom: 10px; right: 10px; background: #ff9800; color: white; border: none; padding: 10px 15px; border-radius: 6px; cursor: pointer; font-size: 14px; font-weight: bold; z-index: 10; box-shadow: 0 4px 8px rgba(0,0,0,0.3); transition: all 0.3s ease;" onmouseover="this.style.background='#ffb74d'; this.style.transform='scale(1.05)'" onmouseout="this.style.background='#ff9800'; this.style.transform='scale(1)'">🔍 Fullscreen</button>
        </div>
        
        <p><strong>If map doesn't load:</strong></p>
        <p>Open map in separate window: <strong><a href="http://noctrl.nolags.fun:20903/" target="_blank" style="color: #ffd700; text-decoration: underline;">http://noctrl.nolags.fun:20903/</a></strong></p>
...
function loadPage(pageName) {
  ...
  const currentBreadcrumb = breadcrumbs[lang][pageName];
  if (pageSubtitle) {
    pageSubtitle.innerHTML = `<span style="color: #999;">📍 ${currentBreadcrumb}</span>`;
  }
  ...
  document.querySelector(`[onclick="loadPage('${pageName}'); closeMobileMenu();"]`)?.classList.add('active');
...
function openMapFullscreen() {
  window.open('http://noctrl.nolags.fun:20903/', 'map', 'width=1200,height=800,resizable=yes,scrollbars=yes');
}
